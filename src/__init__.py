...
This is a research simulation for studying emergent
multi-agent behavior under constrained, scientifically accurate conditions.
"""

__version__ = "0.1.0"
__project__ = "Exoplanet Survival Simulation"
